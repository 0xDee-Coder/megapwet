...
async def show_database_menu():
    while True:
        ...
        print("[1] 🗑  Create/Reset Database | Khởi tạo database")
        print("[2] ➕ Generate New Tasks for Completed Wallets | Tạo mới nhiệm vụ cho các wallet đã hoàn thành")
        print("[3] 📊 Show Database Contents | Xem tiến trình các task")
        print("[4] 🔄 Regenerate Tasks for All Wallets | Làm mới nhiệm vụ cho tất cả wallet")
        print("[5] 📝 Add Wallets to Database | Cập nhật wallets mới vào database")
        print("[6] 👋 Exit")
        print()
